        ...
        if(msg.hasOwnProperty('contact')){
            ...
            TelegramDaiLyBalance.findOne({'form':msg.from.id}, 'phone', function(err, data){
                if (data) {
                    ...
                    redT.telegram_daily.sendMessage(msg.from.id, '*PLAYGO88.TK*  Đây là lần đầu tiên bạn sử dụng App DaiLy. Vui lòng ấn CHIA SẺ SỐ ĐIỆN THOẠI để _XÁC THỰC_', opts);
                }
            });
        }
    });*/
